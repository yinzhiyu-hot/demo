...
import cn.wangoon.domain.common.ShardingItemParameters;
...
public abstract class BaseSimpleJob implements SimpleJob {
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        try {
            LogUtils.info(shardingContext, String.format("[%s]Thread ID: %s, Job 开始工作，任务总片数: %s, 当前分片项: %s, 当前参数: %s, 当前任务名称: %s",
                    radomStr,
