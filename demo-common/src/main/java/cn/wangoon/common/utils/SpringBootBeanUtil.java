...
public class SpringBootBeanUtil implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (ObjectUtil.isEmpty(SpringBootBeanUtil.applicationContext)) {
    ...
    public static <T> T registerBean(Class<T> clazz, String beanName) {
        //获取BeanFactory
        DefaultListableBeanFactory defaultListableBeanFactory = CastUtil.cast(applicationContext.getAutowireCapableBeanFactory());
