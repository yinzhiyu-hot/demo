...
/**
 * @Description 时间转换类
 * @PackagePath cn.wangoon.common.utils.DateUtils
 * @Author YINZHIYU
 * @Date 2020-04-15 10:55:00
 * @Version 1.0.0.0
 **/
public class DateUtils {

    private static final SimpleDateFormat dateFormat = new SimpleDateFormat(DatePattern.NORM_DATE_PATTERN);
    private static final SimpleDateFormat dateTimeFormat = new SimpleDateFormat(DatePattern.NORM_DATETIME_PATTERN);
    ...
    public static String getFormatedDateString(float timeZoneOffset) {
        ...
        int newTime = CastUtil.cast(timeZoneOffset * 60 * 60 * 1000);
        TimeZone timeZone;
