 ...
 * @Remark
 * @PackagePath cn.wangoon.common.utils.CookieUtils
 * @Author YINZHIYU
        ...
        try {
            for (Cookie cookie : cookieList) {
                if (cookie.getName().equals(cookieName)) {
                    if (isDecoder) {
                        retValue = URLDecoder.decode(cookie.getValue(), EncodeConstants.ENCODE_UTF8);
                    } else {
    ...
    private static void doSetCookie(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            if (cookieValue == null) {
                ...
                cookieValue = URLEncoder.encode(cookieValue, EncodeConstants.ENCODE_UTF8);
            }
